    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Easynodecoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Easynodecoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  easynodecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Easynodecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ENC, 0.1 ENC, 1 ENC and 10 ENC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Easynodecoin Core is shutting down...") + "<br /><br />" +
